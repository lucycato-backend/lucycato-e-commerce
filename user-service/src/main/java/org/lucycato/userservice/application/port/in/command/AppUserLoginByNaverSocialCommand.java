...
public class AppUserLoginByNaverSocialCommand extends SelfValidating<AppUserLoginByNaverSocialCommand> {
    @NotBlank
    ...
    public AppUserLoginByNaverSocialCommand(String deviceMacAddress, String deviceFcmToken, DeviceOsType deviceOsType, String deiceOsVersion, AppOrBrowserType appOrBrowserType, String appOrBrowserVersion, NetworkType networkType, String locale) {
