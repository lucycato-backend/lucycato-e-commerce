...
public class AppUserLoginByGoogleSocialCommand extends SelfValidating<AppUserLoginByGoogleSocialCommand> {
    @NotBlank
    ...
    public AppUserLoginByGoogleSocialCommand(String deviceMacAddress, String deviceFcmToken, DeviceOsType deviceOsType, String deiceOsVersion, AppOrBrowserType appOrBrowserType, String appOrBrowserVersion, NetworkType networkType, String locale) {
