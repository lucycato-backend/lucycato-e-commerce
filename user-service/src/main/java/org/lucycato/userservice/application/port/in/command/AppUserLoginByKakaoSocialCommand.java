...
public class AppUserLoginByKakaoSocialCommand extends SelfValidating<AppUserLoginByKakaoSocialCommand> {
    ...
    public AppUserLoginByKakaoSocialCommand(String deviceMacAddress, String deviceFcmToken, DeviceOsType deviceOsType, String deiceOsVersion, AppOrBrowserType appOrBrowserType, String appOrBrowserVersion, NetworkType networkType, String locale) {
