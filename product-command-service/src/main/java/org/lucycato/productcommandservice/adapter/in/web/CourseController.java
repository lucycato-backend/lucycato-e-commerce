...
public class CourseController {
    @PostMapping("api/admin/v1/courses")
    public void registerCourse() {

    }

    @PostMapping("api/admin/v1/courses/{coursesId}/lectures")
    public void registerCourseLecture(@PathVariable Long coursesId) {

    }

    @PostMapping("api/admin/v1/courses/{courseId}/text-e-books")
    public void registerCourseTextEBook(@PathVariable Long courseId) {

    }

    @PostMapping("api/app/v1/courses/{courseId}/reviews")
    public void registerCourseReview() {

    }

    @PatchMapping("api/admin/v1/courses/{courseId}")
    public void modifyCourse() {

    }

    @PatchMapping("api/admin/v1/courses/{courseId}/lecture/{lectureId}")
    public void modifyCourseLecture(@PathVariable Long courseId, @PathVariable Long lectureId) {

    }

    @PatchMapping("api/admin/v1/courses/{courseId}/text-e-books/{textEBookId}")
    public void modifyCourseTextEBook(@PathVariable Long courseId, @PathVariable Long lectureId) {

    }

    @PatchMapping("api/app/v1/courses/{courseId}/reviews/{reviewId}")
